...
public class Format {
	...
	private static final float feet_metre = 3.28084f;
	...
	public static float inch2mm(Float val) {
		if(val == null) return 0;
		return (float) (val * 25.4);
	}
	
	public static float feet2m(Float val) {
		if (val == null) return 0;
		return (val / feet_metre);
	}
	
	public static float m2feet(Float val) {
		if (val == null) return 0;
		return (val * feet_metre);
	}
